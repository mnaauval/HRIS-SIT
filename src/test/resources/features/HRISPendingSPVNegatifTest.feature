...
Feature: Request Staff
  ...
  #FORM DETAIL
  @tujuanTidakDipilih
  Scenario Outline: Pending spv input data select tujuan tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
  ...
  #ada
  @NIKkarakter
  Scenario Outline: Pending spv input data Nik dengan spesial karakter
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @NIKkosong
  Scenario Outline: Pending spv input data Nik kosong
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @posisiTidakDipilih
  Scenario Outline: Pending spv input data select tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @jumlahOrang0
  Scenario Outline: Pending spv input data jumlah orang dengan 0
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data jumlah orang dengan huruf
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data mulai kerja input manual
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data lokasi kerja tidak dipilih
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data kota lokasi krja tidak dipilih
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data detail lokasi kerja kosong
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data deskripsi pekerjaan kosong
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data select jenis kelamin tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #edit
  @inputUmurInvalid
  Scenario Outline: Pending spv input data umur tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data start umur > batas umur
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data select pendidikan tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data select status perkawinan tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data kualifikasi lainnya tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan PKWT input bulan > 12, bulan > 2 digit angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan PKWT check bulan invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan PKWT check tahun
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang input bulan > 12, bulan > 2 digit angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang check bulan invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang check tahun
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang Harian input bulan > 12, bulan > 2 digit angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang Harian check bulan invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang Harian check tahun
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Mitra input bulan > 12, bulan > 2 digit angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Mitra check bulan invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Mitra check tahun
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status masa percobaan input bulan > 12, bulan > 2 digit angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data check masa percobaan bulan invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv select golongan jabatan tidak dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #GAJI
  @cekGajiInvalid
  Scenario Outline: Pending spv input data cek field gaji
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data checkbox asuransi dipilih
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan jabatan dengan data invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan transportasi dengan data invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan komunikasi dengan data invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #NOTE, pass
  @noteDataInvalid
  Scenario Outline: Pending spv input data cek note dengan data invalid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
