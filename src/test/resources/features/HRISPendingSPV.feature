...
Feature: Request Staff
  ...
  Scenario: Request Staff pending spv
  ...
  @searchData
  Scenario Outline: Request Staff pending spv search data positif test
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
  ...
  #SHOW DATA
  @showData
  Scenario: Request Staff pending spv show data
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
  ...
  @KaryawanBaru
  Scenario Outline: Pending spv input data Nik
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
  ...
  @Nikterdaftar
  Scenario Outline: Pending spv input data Nik Data yang terdaftar
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @JumlahOrangValid
  Scenario Outline: Pending spv input data jumlah orang valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data mulai kerja datepicker
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @lokasiKerjaDika
  Scenario Outline: Pending spv input data lokasi kerja pilih dika 1 lt 2
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @lokasikerja
  Scenario Outline: Pending spv input data lokasi kerja valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data detail lokasi kerja dengan huruf angka dan spesial karakter
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data deskripsi pekerjaan dengan huruf angka dan spesial karakter
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #
  @selectJKdilakukan
  Scenario Outline: Pending spv input data select jenis kelamin dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #
  @umurDataValid
  Scenario Outline: Pending spv input data umur dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data select pendidikan dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data select status perkawinan dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data kualifikasi lainnya dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan permanen
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan PKWT
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan PKWT check bulan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @KaryawanMagang
  Scenario Outline: Pending spv input data memilih status karyawan Magang input bulan dan tahun valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data memilih status karyawan Magang Harian input bulan dan tahun valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  @KaryawanMitra
  Scenario Outline: Pending spv input data memilih status karyawan Mitra input bulan dan tahun valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #masih eror #sudah
  @cekMasaPercobaan
  Scenario Outline: Pending spv input data masa percobaan dengan angka
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv select golongan jabatan dilakukan
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #GAJI
  @cekGajiValid
  Scenario Outline: Pending spv input data cek gaji dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan jabatan dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan transportasi dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  Scenario Outline: Pending spv input data cek tunjangan komunikasi dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #NOTE
  @noteDataValid
  Scenario Outline: Pending spv input data cek note dengan data valid
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
    When User menekan button input data
  ...
  #DETAIL DATA
  @cekDetailData
  Scenario: Pending spv cek detail data btn eye
    Given User berhasil login sebagai SPV
    When User memilih Request Staff
    And User memilih sub menu Pending
