...
@CucumberOptions(tags = "", features = "src/test/resources/features/005-MODUL PROMOTION/HRISAddPromotionJabatan.feature", 
glue = "definitions.promotion")
public class HRISPagePromotionJabatan extends AbstractTestNGCucumberTests {
