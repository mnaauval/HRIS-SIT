...
@CucumberOptions(tags = "", features = "src/test/resources/features/005-MODUL PROMOTION/HRISAddPromotionJabatan_Negatif.feature", 
glue = "definitions.promotion")
public class HRISPagePromotionJabatanNeg extends AbstractTestNGCucumberTests {
