...
@CucumberOptions(tags = "", features = "src/test/resources/features/005-MODUL PROMOTION/HRISAddPromotionContract.feature", 
glue = "definitions.promotion")
public class HRISPagePromotionContract extends AbstractTestNGCucumberTests {
